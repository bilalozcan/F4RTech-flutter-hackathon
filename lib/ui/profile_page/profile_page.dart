    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Container(
            height:
                Constants.getHeight(context) - Constants.getHeight(context) / 4,
            width: Constants.getWidth(context),
            child: Column(
              children: [
                UserInfoWidget("Mehmet arsay", "arsay454"),
                UserInfoWidget2("E-Posta", "Mehmetarsay@gmail.com"),
                UserInfoWidget2("Telefon", "05555555555"),
                Listwidget(model),
              ],
            ),
          )
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: Colors.white, boxShadow: [
          BoxShadow(
              color: ColorTable.swatch1.withOpacity(0.2),
              blurRadius: 10)
        ]),
        child: Column(
          children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Colors.white,
                        border: model.listType == false ? Border.all(width: 2,color: ColorTable.swatch7):Border.all(width: 2,color: ColorTable.swatch7.withOpacity(0)),
                        boxShadow: [
                          BoxShadow(
                    ...
                    child:  Center(child: Text("Eklenen Öğrenciler",style:GoogleFonts.poppins(
                        color: ColorTable.textColor,
                        fontSize: 11
                    ),)),
                  ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.all(Radius.circular(5)),
                        color: Colors.white,
                        border:model.listType == true ? Border.all(width: 2,color: ColorTable.swatch7):Border.all(width: 2,color: ColorTable.swatch7.withOpacity(0)),
                        boxShadow: [
                          BoxShadow(
                              color: Colors.black.withOpacity(0.1),
                              blurRadius: 8
                    ...
                    child:  Center(child: Text("Yapılan  Bağışlar",style:GoogleFonts.poppins(
                        color: ColorTable.textColor,
                        fontSize: 11
                    ),)),
                  ),
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: model.listType ==false ? AddStudentWidget():YApilanBagis(),
            );
          }),
    );
  }
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: ColorTable.swatch2.withOpacity(0.8),
              blurRadius: 8
            )
          ]
        ),
